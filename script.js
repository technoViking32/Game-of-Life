...
function getPattern(glider) {
    return pattern[glider] || null;
}
...
function initialize() {
    ...
    let selectedpattern = getPattern('glider');
    if (selectedpattern) {
        addPatternToGrid(grid, selectedpattern, 15, 15);
    }
    updateView();
    setupControlButtons();
}
